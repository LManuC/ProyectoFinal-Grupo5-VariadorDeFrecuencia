...
Los ensayos permiten comprobar tanto el desempeño del conversor, como el comportamiento del inversor, en esto se involucra la conmutación de los MOSFET, la modulación (SVM) implementada y el programa de control.
