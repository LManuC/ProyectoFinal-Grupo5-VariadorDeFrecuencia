...
\hl{Incluir una imagen del transformador (Sacar foto)}
...
\hl{Hay comentario de que se usaron dos transistores??}
\hl{Decir lo de los cables cortos y la disipacion termica}
...
\begin{figure}[H]
\centering
    \includegraphics[width=0.9\textwidth]{dev/cnv/img/EsqSimpSim.png}
...
\subsubsection{Dificultades alcanzadas}

En esta sección se pretende detallar las complicaciones alcanzas y la resolución de estas, siendo el conversor el componente de potencia mas complejo para diseñar. 
