...
\subsubsection{GPIO - MCP23017}
    ...
    \large{\textbf{Buzzer}}
        ...
        El buzzer\footcite{Buzzer_datasheet} será una herramienta que, en caso de haber tenido una pulsada en el panel frontal, se envía un evento a una tarea llamada \textit{MCP23017\_buzzer\_control} para que el buzzer suene y el usuario entienda que su pulsada fue registrada.
