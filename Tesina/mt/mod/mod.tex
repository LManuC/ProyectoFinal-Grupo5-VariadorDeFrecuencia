...
Ventajas de la Modulación SVM frente a técnicas PWM convencionales
...
Los tiempos de aplicación de cada vector se determinan a partir de las siguientes constantes:

\[
A = \frac{3 \sqrt{3}}{2\pi} \ T
\]
\[
B = \frac{3}{\pi} \ T
\]
...
Los tiempos de permanencia de cada vector se obtienen mediante:
