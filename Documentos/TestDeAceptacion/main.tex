...
Además se evaluó el perfil de incremento de temperatura del transformador en la figura~\ref{fig:Temperatura} y, en las figuras~\ref{fig:Temperatura-vs-Corriente} y ~\ref{fig:Temperatura-vs-Tension} como las tensión y corriente del bus de contínua se mantienen estables durante toda la prueba frente a la variación de temperatura.
