...
\subsubsection{Configuración Wi-Fi}
    ...
    El ESP32 genera una red Wi-Fi como access point (AP) que, conectándose a ella, se accede a un formulario WEB que permitirá configurar los mismos parámetros descritos en la sección anterior. Además se podrá encender y apagar el motor desde allí con los parámetros ya guardados. En la figura~\ref{} se muestra la interfaz gráfica.
