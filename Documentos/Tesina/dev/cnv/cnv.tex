...
\subsubsection{Selección de topología}

El módulo conversor debe:
\begin{itemize}
    \item Elevar de 12Vdc a 320Vdc,
...
\subsubsection{Requerimientos mínimos eléctricos}
...
En la figura~\ref{fig:cnv_EDT36_referencias_medidas} se pueden ver referencias de las medidas descriptas.
\begin{table}[H]
\centering
\renewcommand{\arraystretch}{1.2}
\begin{tabular}{|l|l|}
...
De acuerdo con la curva de área de operación segura, el dispositivo trabaja dentro de condiciones seguras, considerando pulsos de $20 \mu s$ y tensión de $24 V$, muy por debajo de sus límites máximos.
...
Para anticipar y evaluar el diseño del circuito se utilizó la herramienta LTSpice para la simulación, algo que se muestra en la figura ~\ref{fig:imgDev_EsqSimSimplificado}. Solo se buscó analizar el comportamiento tanto del transformador como de los transistores de potencia y la etapa de filtrado. Se excluyó el circuito de control por la complejidad. En este se colocó el transformador con sus tres arrollamientos con un acoplamiento unitario además de los componentes complementarios. 

Para asegurar un buen funcionamiento del conversor en las simulaciones se exigió ligeramente al circuito, colocando una carga que consuma $400W$ para generar corrientes más grandes sobre los transistores.
...
Se inyectaron dos señales a las compuertas de los transistores de $0V$ a $12V$ con un ciclo de actividad de $45\%$ y una frecuencia de $50 kHz$ con la de la figura ~\ref{fig:imgDev_SimVgs}.
...
Por un lado, se obtuvo la tensión entre drenaje y fuente, la cual desciende a $0V$ cuando el transistor conduce y a $24V$ (el doble de la tensión de fuente) cuando deja de hacerlo, lo esperado en una topología push-pull. Por otro lado, en la figura~\ref{fig:imgDev_SimVds} se muestra el arranque del sistema.
