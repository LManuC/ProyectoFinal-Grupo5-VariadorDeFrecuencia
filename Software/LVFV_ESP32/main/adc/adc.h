 ...
 *
 * @retval 
 *      - true: Si el sistema está inicializado y las mediciones pueden ser obtenidas
 *      - false: Si el sistema todavía no inición y las mediciones que pudo haber obtenido fueron inválidas
 */
bool readADC(void);
