...
typedef enum {
    SPI_COMMAND_START       = 10,
    SPI_COMMAND_STOP        = 11,
    SPI_COMMAND_SET_FREC    = 12,
    SPI_COMMAND_SET_ACEL    = 13,
    SPI_COMMAND_SET_DESACEL = 14,
    SPI_COMMAND_SET_DIR     = 15,
    SPI_COMMAND_GET_FREC    = 16,
    SPI_COMMAND_GET_ACEL    = 17,
    SPI_COMMAND_GET_DESACEL = 18,
    SPI_COMMAND_GET_DIR     = 19,
    SPI_COMMAND_IS_STOP     = 20,
    SPI_COMMAND_EMERGENCY   = 21,
    SPI_COMMAND_LAST        = 22,
} SPI_Command;
 ...
 */
SPI_Response SPI_SendRequest(SPI_Command request, int setValue, int* getValue);
